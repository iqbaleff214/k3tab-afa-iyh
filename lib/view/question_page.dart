            ...
            children: [
              ...
              Column(
                ...
                children: questionIndex >= 0 ? [
                  ...
                  Center(child: Text(widget.engine.results[answers.toString()]?.definition ?? 'No result found, sorry!', style: GoogleFonts.poppins().copyWith(fontWeight: FontWeight.w600, fontSize: 16), textAlign: TextAlign.center,)),
                  const SizedBox(height: 24),
                  (widget.engine.results[answers.toString()]?.causes.length ?? 0) > 0 ? Center(child: Text('Probable causes', style: GoogleFonts.poppins().copyWith(fontWeight: FontWeight.w600, fontSize: 14, color: Colors.red), textAlign: TextAlign.center,)) : const SizedBox(),
                  ...widget.engine.results[answers.toString()]?.causes.map((String cause) => Padding(
                    padding: const EdgeInsets.only(top: 8, left: 8),
                    child: Text('•  ' + cause, style: GoogleFonts.poppins().copyWith(fontWeight: FontWeight.w500, fontSize: 14), textAlign: TextAlign.start,),
                  )).toList() ?? [],
                ],
              ),
                ...
                child: Row(
                  ...
                  children: questionIndex >= 0 ? [
                    TextButton(
                      ...
                      child: Text("Yes", style: GoogleFonts.poppins().copyWith(color: Colors.white, fontWeight: FontWeight.w600),),
                    ),
                    ...
                    TextButton(
                      ...
                      child: Text("No", style: GoogleFonts.poppins().copyWith(color: Colors.black, fontWeight: FontWeight.w600),),
                    ),
                  ] : [
                    TextButton(
                      onPressed: () {
                      ...
                      child: Text("OK", style: GoogleFonts.poppins().copyWith(color: Colors.white, fontWeight: FontWeight.w600),),
                    )
                  ],
                ),
              ),
